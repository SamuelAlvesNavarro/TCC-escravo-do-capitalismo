<?php
    ...
    if($type == 0){
        ...
        //main
        move_uploaded_file($name['tmp_name'], "../../main/profile-gadgets/pc-profile");

        //mod
        move_uploaded_file($name['tmp_name'], "../../mods/profile-gadgets/pc-profile");
    }else{
        $path = "background-image: url(../profile-gadgets/pc-profile/$name_image.$extensao";
        //main
        move_uploaded_file($name['tmp_name'], "../../main/profile-gadgets/bc-profile");

        //mod
        move_uploaded_file($name['tmp_name'], "../../mods/profile-gadgets/bc-profile");
    }
